              ...
              <div className="flex items-center justify-center gap-2">
                {currentPage > 1 && (
                  <Link
                    ...
                    className="rounded-lg border border-slate-700 bg-slate-900 px-3 py-2 text-xs md:text-sm text-slate-300 hover:bg-slate-800 transition"
                  >
                    ← Prev
                  </Link>
                )}
                    ...
                    <Link
                      ...
                      className={`rounded-md border px-2.5 py-1.5 text-xs transition ${
                        isActive
                          ...
                          : 'border-slate-700 bg-slate-900 text-slate-300 hover:bg-slate-800 hover:text-cyan-400'
                      }`}
                    >
                      {pageNum}
                    </Link>
